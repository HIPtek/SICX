...
public class DefaultFECCodeFactory extends FECCodeFactory {
    ...
    public DefaultFECCodeFactory() {
        ...
        try {
            ...
            fecProperties.load(DefaultFECCodeFactory.class.getClassLoader().getResourceAsStream("fec.properties"));
            //fecProperties.load(DefaultFECCodeFactory.class.getClassLoader().getResourceAsStream(System.getProperty("com.onionnetworks.fec.defaultfeccodefactorypropertiesfile","lib/fec.properties")));
            //fecProperties.load(new FileInputStream("./lib/fec.properties"));
        } catch (IOException e) {
            e.printStackTrace();
